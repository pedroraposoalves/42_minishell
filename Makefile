...
#    Updated: 2024/11/20 19:42:46 by malves-b         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJS = $(patsubst srcs/%.c, objs/srcs/%.o, $(wildcard srcs/*.c)) \
       ...
       $(patsubst exec/%.c, objs/exec/%.o, $(wildcard exec/*.c))
...
create_objs:
	@mkdir -p objs/srcs objs/libft objs/tokenization objs/check objs/parse objs/exec
